# OBJC-HomemadeBlockProgram — አማርኛ

ይህ ለOpenBSD የObjective-C የትእዛዝ-መስመር ፕሮግራም ነው፣ ከሎግ የጥቃት አድራሻ IP ይከለክላል እና የቆዩ እገዳዎችን ያስወግዳል።

የተተረጎሙ የአጠቃቀም መመሪያዎች ከታች አሉ፤ ሙሉ የእንግሊዝኛ README ለሙሉ መሳሰል ተካትቷል።

## Localized usage directions

- `pf-blocker --monitor-invalid-user`  
  በsshd "Invalid user" ሎግ የታዩ IP አድራሻዎችን አግድ።
- `pf-blocker --monitor-disconnect`  
  በsshd "Received disconnect from" ሎግ የታዩ IP አድራሻዎችን አግድ።
- `pf-blocker --monitor-allowlist-violations`  
  በተወሰነው የጊዜ መስኮት ውስጥ የallowlist ጥሰት ገደብ የሚበልጡ IP አግድ።
- `pf-blocker --monitor-slowloris-violations`  
  በSlowloris መለያ የተደረጉ IP ወደ blocker ledger አስገባ።
- `pf-blocker --monitor-ddos`  
  በDDoS መለያ የተደረጉ IP ወደ blocker ledger አስገባ።
- `pf-blocker --expire-blocks`  
  ከblock ፋይል እና ledger ውስጥ የቆዩ እገዳዎችን አስወግድ።
