# OBJC-HomemadeBlockProgram — Gaeilge

Is clár líne ordaithe Objective-C é seo do OpenBSD a chuireann bac ar IP ionsaitheoirí ó logaí agus a ligeann do bhacanna sean dul in éag.

Tá treoracha úsáide logánaithe thíos; tá an README iomlán i mBéarla san áireamh le haghaidh paireachta iomláine.

## Localized usage directions

- `pf-blocker --monitor-invalid-user`  
  Cuir bac ar IPanna a fheictear i logaí sshd "Invalid user".
- `pf-blocker --monitor-disconnect`  
  Cuir bac ar IPanna a fheictear i logaí sshd "Received disconnect from".
- `pf-blocker --monitor-allowlist-violations`  
  Cuir bac ar IPanna a sháraíonn tairseach sáruithe allowlist laistigh den fhuinneog chumraithe.
- `pf-blocker --monitor-slowloris-violations`  
  Iompórtáil IPanna a mharcáil braiteoir Slowloris isteach sa ledger blocker.
- `pf-blocker --monitor-ddos`  
  Iompórtáil IPanna a mharcáil braiteoir DDoS isteach sa ledger blocker.
- `pf-blocker --expire-blocks`  
  Bain seanbhacanna den chomhad blocála agus den ledger.
