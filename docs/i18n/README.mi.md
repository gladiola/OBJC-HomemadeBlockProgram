# OBJC-HomemadeBlockProgram — Te Reo Māori

He hōtaka raina-whakahau Objective-C mō OpenBSD e aukati ana i ngā IP kaiwhai mai i ngā rārangi takiuru, ā, ka whakamutu i ngā aukatinga tawhito.

Kei raro iho ngā tohutohu whakamahi kua whakamāoritia; kua whakaurua te README Ingarihi katoa mō te ōritetanga katoa.

## Localized usage directions

- `pf-blocker --monitor-invalid-user`  
  Aukati i ngā IP ka kitea i ngā rārangi sshd "Invalid user".
- `pf-blocker --monitor-disconnect`  
  Aukati i ngā IP ka kitea i ngā rārangi sshd "Received disconnect from".
- `pf-blocker --monitor-allowlist-violations`  
  Aukati i ngā IP kua hipa i te paepae takahi allowlist i roto i te matapihi kua tautuhia.
- `pf-blocker --monitor-slowloris-violations`  
  Kawea mai ngā IP kua tohua e te kaitirotiro Slowloris ki te rārangi blocker.
- `pf-blocker --monitor-ddos`  
  Kawea mai ngā IP kua tohua e te kaitirotiro DDoS ki te rārangi blocker.
- `pf-blocker --expire-blocks`  
  Tangohia ngā aukatinga tawhito i te kōnae aukati me te rārangi.
